const projectProcess = [
  {
    ...
    intro: {
      description: `Solt는 **AI 기반 맞춤형 여행 플랜 생성 서비스**입니다.    
        사용자가 여행 지역, 기간, 취향, 희망 장소를 입력하면, **AI가 예산과 동선을 고려한 최적의 여행 플랜을 추천**하며, 추천된 일정은 사용자가 자유롭게 수정하고, 저장하거나 공유할 수 있습니다.`,
      purpose: `여행 계획을 짤 시간이 없는 바쁜 사람들과, 계획 자체에 스트레스를 느끼는 사람들을 위해 기획했습니다. 누구나 쉽게 여행 일정을 구성할 수 있도록 AI가 가이드를 제공하며, 사용자는 추천된 일정을 편집하거나 재추천을 받을 수 있습니다.    또한 231명을 대상으로 사전 설문조사를 진행해 여행 시 불편했던 점과 선호 스타일을 파악하고, 그 결과를 서비스 기획에 반영했습니다.`,
    ...
    contribut: {
      ...
      function: [
        ...
        {
          title: '플랜 저장 및 공유 기능',
          content: '생성한 플랜을 저장하거나, 공유된 플랜을 불러와 내 일정으로 수정 가능하게 했습니다.',
        },
      ],
    },
  ...
  },
  {
    ...
    contribut: {
      role: [
        '개인 프로젝트로, 기획부터 디자인, 개발까지 전 과정 단독 수행',
